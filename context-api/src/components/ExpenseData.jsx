...
const ExpenseData = () => {
  ...
  return (
    <>
      <div className="d-flex text-white w-75 mb-4 align-items-center justify-content-center py-4 rounded-5 border bg-white">
        <h1 className="me-2 text-success">Credit:</h1>
        <h1 className="text-success">{credit}</h1>
      </div>

      <div className="d-flex text-white w-75 border mb-4 align-items-center justify-content-center py-4 rounded-5 bg-white">
